...
export const personalityTypes: PersonalityTypeDefinition[] = [
  ...
  },
  {
    ...
    englishName: '送钱者',
    subtitle: 'ATM-er',
    description: '你是三国杀中的"散财童子"鲁肃，乐善好施到让队友心惊肉跳。你的手牌就像流水一样往外送，美其名曰"投资"，实则是纯纯的ATM体质。别人打三国杀是来赢的，你是来做慈善的。你的缔盟让对面感动到想给你发锦旗，你的好施让你自己的手牌比脸还干净。你是全场最想保护的人，也是全场最容易被集火的人——因为谁都知道，打你等于打两份收益。生活中的你也是朋友圈里的提款机，"我请""没事我来""这点小钱不算什么"是你的口头禅。月底看余额的时候你的表情和被乐不思蜀时一模一样——欲哭无泪但下次还敢。',
  ...
  },
  {
    ...
    englishName: '梦想家',
    subtitle: 'DREAM-er',
    description: '你是白日梦想家刘焉，梦里一杆丈八蛇矛耍的有模有样，一时不知道你和张飞谁才是它的主人。你的激情可以点燃全场，你的乐观可以感染队友，虽然经常翻车，但你的梦想从未熄灭。选到刘焉的那一刻，你的眼里就已经只有丈八蛇矛了，仿佛下一秒就能七杀超神。然现实往往是：图还没摸到，血已经见底；丈八在手，对面已经闪满了。但你从不气馁，翻车了只是微微一笑："再来一把，这次一定行。"你的人生信条就是赌，大赌大赢，小赌小赢，不赌那才是真输。生活中的你也是永不停歇的梦想家，创业计划写了八版，投资方案换了三轮，虽然目前还在"即将起飞"阶段，但你的眼里永远闪着光——那是丈八蛇矛的光。',
  ...
  },
  {
    ...
    englishName: '妈沫',
    subtitle: 'MUM',
    description: '你是场上的操心命诸葛亮，所有人的妈沫。你既要观星看牌顶，又要空城保自己，既要保核保主公，又要控底防内奸——你的手比千手观音还忙。别人玩三国杀是来爽的，你玩三国杀是来上班的。你的观星不是超能力，是你操碎了心的证明；你的空城不是从容，是你已经弹尽粮绝还要硬撑的倔强。你是全场的总指挥、大管家、安全员，谁的血量你都记着，谁的手牌你都在算。你的队友或许不记得你打了什么牌，但一定记得每次快死的时候，是你挡在了前面。生活中的你也是朋友圈的定海神针，群聊里永远是你提醒这提醒那，出行攻略永远是你做，迷路了大家都看向你——累是真累，但谁让你放不下心呢。',
    quote: '「你们都给我活着，我来断后！」',
  ...
  },
  {
    ...
    englishName: '熹飞回宫',
    subtitle: 'BACK',
    description: '你是魔张飞，三国杀里唯一持证上岗的 "颜色验货员"。你的战场哲学简单粗暴：先问颜色，再问生死。别人打牌算概率算收益，你打牌只需要做一件事 —— 扫一眼对面勾玉，然后决定砍一个还是砍两个。黑杀在你手里不是武器，是决斗邀请函；闪在你手里也不是防御，是下一轮还回去的组合拳。对手满血以为自己很安全？对不起，你的回合没有 "安全" 这两个字，只有 "这是什么颜色" 和 "下一个是什么颜色"。\n生活中你是团队的 "氛围点火器"—— 再沉闷的局，你一来就开始冒火星子。大家还在寒暄客气，你已经用在决斗说HELLO；大家还在互相试探，你已经一破，卧龙出山。你不是故意要搞事情，你只是受不了 "明明都想干但没人敢第一个动"。你的存在本身就是一种许可：你动了，别人就敢动了。朋友说你 "带节奏"，你说 "我不带就没人带了"。你的字典里没有 "预热期"，上来就是高潮，毕竟火都点着了，谁还慢慢升温？',
    quote: '「察言观色不是礼貌，而是砍你的预告」',
